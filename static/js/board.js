...
//3: Функція малювання НОВИХ полігонів
...
function draw(data) {
    ...
    // *************************************************************************************** //
    // *************************************************************************************** //
    // // Отрисовка пути и карты задания (VRA)
    // bgCtx.save();
    ...
    // // Вона використовує ті ж самі зміщення, тому ідеально стане на своє місце
    // if (isVraMapRendered) {
    ...
    // bgCtx.restore(); // Повертаємо контекст назад
    // // *************************************************************************************** //
    // // Отрисовка пути
    // bgCtx.save();
    // bgCtx.translate(bgCanvas.width / 2, bgCanvas.height / 2);
    // bgCtx.rotate(-data.hdg * Math.PI / 180);
    // bgCtx.scale(scaleFactor, scaleFactor); // Використовуємо transform для масштабування всієї картинки буфера
    // bgCtx.drawImage(fieldCanvas, -(tx_m * 10 + fCenterX), -(ty_m * 10 + fCenterY)); // Тепер малюємо буфер Оскільки ми вже зробили scale, координати tx_m/ty_m теж масштабуються автоматично
